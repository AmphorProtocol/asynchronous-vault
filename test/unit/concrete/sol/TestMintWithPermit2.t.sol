...
contract TestMintWithPermit2 {
    ...
    function test_GivenPermit2SpenderIsNotTheVaultWhenMint() external {
        // it should revert with InvalidSpender()
    }

    function test_GivenPermit2DeadlineIsInThePastWhenMint() external {
