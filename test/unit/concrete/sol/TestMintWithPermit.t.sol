...
contract TestMintWithPermit {
    ...
    function test_GivenPermitSpenderIsNotTheVaultWhenMint() external {
        // it should revert with InvalidSpender()
    }

    function test_GivenPermitDeadlineIsInThePastWhenMint() external {
